...
class OnboardingViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let introPage = storyboard?.instantiateViewController(withIdentifier: "onboardingTemplate") as? OnboardingTemplateViewController {
            ...
            introPage.contentText = "IndiePass allows you to engage with the Internet as you do on social media sites, but posts it all on your website. Use the built-in reader to read and respond to posts across the internet. IndiePass doesn’t track or store any of your information. You choose a service you trust or host it yourself."
        ...
        if let micropubPage = storyboard?.instantiateViewController(withIdentifier: "onboardingTemplate") as? OnboardingTemplateViewController {
            ...
            micropubPage.buttonUrl = URL(string: "https://indiepass.app/ios/help/#micropub")
        ...
        if let microsubPage = storyboard?.instantiateViewController(withIdentifier: "onboardingTemplate") as? OnboardingTemplateViewController {
            ...
            microsubPage.contentText = "You can read posts within IndiePass if your website supports Microsub. The primary service that currently supports Microsub is Aperture."
            microsubPage.buttonText = "Learn About Microsub"
            microsubPage.buttonUrl = URL(string: "https://indiepass.app/ios/help/#microsub")
